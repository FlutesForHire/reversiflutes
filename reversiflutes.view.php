 ...
 * particular, you can set here the values of variables elements defined in reversiflutes_reversiflutes.tpl (elements
...
class view_reversiflutes_reversiflutes extends game_view
{
    protected function getGameName()
    {
  	...
  	{		
        ...
        */
        ...
        $this->page->begin_block( "reversiflutes_reversiflutes", "myblock" );
